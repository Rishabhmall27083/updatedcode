        ...
        <ul style={{marginBottom:"210px",marginLeft:"-53px"}}><br /><br />
          ...
          <li>
            {/* <a href="#" >
              ...
              <span className="nav-text" onClick={handleClick} style={{ cursor: isEnrolled ? 'pointer' : 'not-allowed', color: isEnrolled ? 'black' : 'gray' }}>
                Enrollment
              </span>

            </a> */}
            <a href="#" className={buttonClassName} onClick={handleClick} disabled={!isEnrolled}>
              <i className="fa fa-image nav-icon" />
          ...
          <li>
            <a href="#">
              ...
              <span className="nav-text"> <Link to="/erp/studentlogin"> Logout</Link> </span>
            </a>
          </li><br />
        </ul>
        <ul className="logout">
